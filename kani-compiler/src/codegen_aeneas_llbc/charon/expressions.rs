...
pub use super::expressions_utils::*;
use super::gast::{FunDeclId, TraitItemName};
use super::types::*;
pub use super::values::VarId;
use super::values::*;
use charon_macros::{EnumAsGetters, EnumIsA, EnumToGetters, VariantIndexArity, VariantName};
use serde::Serialize;
use std::vec::Vec;
...
pub enum ProjectionElem {
    ...
    DerefBox,
    /// Dereference a raw pointer. See the comments for [super::types::Ty::RawPtr].
...
pub enum FieldProjKind {
    ...
    /// We eliminate this in a micro-pass ([super::update_closure_signatures]).
    ClosureState,
}
...
/// A function identifier. See [super::ullbc_ast::Terminator]
...
pub enum AssumedFunId {
    ...
    /// following (this is hardcoded - see [super::register] and [super::translate_functions_to_ullbc]):
    /// ```text
    /// alloc::alloc::box_free::<T>(move b)
    /// ```
    ///
    /// Also see the comments in [super::assumed::type_to_used_params].
    BoxFree,
...
pub enum Rvalue {
    ...
    ///
    /// This case is filtered in [super::remove_read_discriminant]
