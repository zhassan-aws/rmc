use super::assumed;
use super::common::*;
use super::formatter::IntoFormatter;
use super::gast::*;
...
impl<'tcx, 'ctx, 'ctx1> BodyTransCtx<'tcx, 'ctx, 'ctx1> {
        ...
        if erase_regions {
            ...
            match &region.kind {
                ...
                hax::RegionKind::ReVar(re_var) => {
                    ...
                    // ... // omitted
                    //
                    // fn super::{bool}::from<@R0, @R1>(@1: &@R1 (bool)) ->
                    //   core::result::Result<bool, super::{bool}<@R0>::Error> {
                    //   //                                       ^^^
    ...
    ///
    /// Rem.: this seems simpler in [super::translate_functions_to_ullbc].
