//! This file groups everything which is linked to implementations about [super::types]
use super::assumed::get_name_from_type_id;
use super::common::TAB_INCR;
...
impl TySubst {
    ...
    fn unify_args(
        &mut self,
        src: &super::gast::GenericArgs,
        tgt: &super::gast::GenericArgs,
    ) -> Result<(), ()> {
        if !self.ignore_regions {
