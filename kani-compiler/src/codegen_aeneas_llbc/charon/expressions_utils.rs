//! This file groups everything which is linked to implementations about [super::expressions]
use super::expressions::*;
use super::formatter::{AstFormatter, FmtCtx};
use super::gast::{AssumedFunId, Call, FnOperand, FunId, FunIdOrTraitMethodRef, TraitItemName};
use super::types::*;
use super::ullbc_ast::GlobalDeclId;
use super::values::*;
use charon_macros::make_generic_in_borrows;
use std::vec::Vec;
...
pub trait ExprVisitor: crate::codegen_aeneas_llbc::charon::types::TypeVisitor {
