//! Implementations for [super::gast]

use super::common::TAB_INCR;
use super::formatter::{AstFormatter, Formatter, SetGenerics, SetLocals};
use super::gast::*;
...
impl<T> GExprBody<T> {
    ...
    /// definition). See [`fmt_with_decls`](super::ullbc_ast::FunDecl::fmt_with_decls).
