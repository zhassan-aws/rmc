...
use super::translate_crate_to_ullbc;
use super::translate_ctx;
use super::ullbc_to_llbc;
use regex::Regex;
...
impl Callbacks for CharonCallbacks {
    ...
    /// possible (i.e., after parsing). See [super::get_mir].
    fn after_crate_root_parsing<'tcx>(&mut self, c: &Compiler, queries: &'tcx Queries<'tcx>) -> Compilation {
...
pub fn translate(
    ...
    let crate_data = if options.ullbc {
        ...
        if options.print_built_llbc {
            let llbc_ctx = super::translate_ctx::LlbcTransCtx {
                ctx: &ctx,
        ...
        // See the comments in [super::remove_dynamic_checks].
        ...
        use super::formatter::{Formatter, IntoFormatter};
