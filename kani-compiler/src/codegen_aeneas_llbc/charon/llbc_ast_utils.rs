//! Implementations for [super::llbc_ast]

use super::common::*;
use super::expressions::{MutExprVisitor, Operand, Place, Rvalue};
use super::formatter::{AstFormatter, Formatter};
use super::llbc_ast::{Assert, FunDecl, GlobalDecl, RawStatement, Statement, Switch};
use super::meta;
use super::meta::Meta;
use super::types::*;
pub use super::ullbc_ast::fmt_call;
use super::values::*;
...
pub trait AstVisitor: super::expressions::ExprVisitor {
