use super::common::*;
use super::formatter::{AstFormatter, Formatter, IntoFormatter};
use super::gast::*;
use super::graphs::*;
...
use charon_macros::{EnumAsGetters, EnumIsA, VariantIndexArity, VariantName};
...
mod tests {
    ...
    fn test_reorder_sccs1() {
        ...
        let reordered = super::reorder_decls::reorder_sccs(get_deps, &ids, &sccs);
