...
macro_rules! generate_index_type {
    ($name:ident) => {
        ...
        pub mod $name {
            ...
            pub type Vector<T> = super::ids::vector::Vector<Id, T>;
            pub type Map<T> = super::ids::map::Map<Id, T>;
            pub type Generator = super::ids::generator::Generator<Id>;
            pub type MapGenerator<K> = super::ids::generator::MapGenerator<K, Id>;
