...
pub enum TraitInstanceId {
    ...
    ///
    ///
    ItemClause(Box<TraitInstanceId>, TraitDeclId::Id, TraitItemName, TraitClauseId::Id),
...
#[derive(Debug, PartialEq, Eq, Copy, Clone, EnumIsA, VariantName, Serialize, Hash, Ord, PartialOrd)]
pub enum IntegerTy {
    Isize,
    I8,
    I16,
...
#[derive(Debug, PartialEq, Eq, Clone, Copy, Hash, VariantName, EnumIsA, Serialize, Ord, PartialOrd)]
pub enum RefKind {
    Mut,
    Shared,
}
